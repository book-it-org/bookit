...
import { Edit, Eye, Power, PowerOff } from 'lucide-vue-next';
import { ref } from 'vue';
...
<template>
    <Card class="group relative w-auto gap-2 p-3">
        ...
        <CardHeader class="px-0.5">
            <CardTitle class="leading-6 font-bold text-sm">
                {{ props.oferta.titulo }}
            </CardTitle>
        ...
        <CardContent class="px-0.5">
            <p class="text-xs text-muted-foreground">
                Estado: {{ props.oferta.estado_livro }}
            </p>
            <p class="text-xs text-muted-foreground">
        ...
        <CardFooter class="flex justify-between px-0.5">
            <p class="text-emerald-500 font-bold">R$ {{ props.oferta.preco }}</p>
            <div class="flex gap-2">
                ...
                >
                    <PowerOff v-if="oferta.ativo" class="h-4 w-4" />
